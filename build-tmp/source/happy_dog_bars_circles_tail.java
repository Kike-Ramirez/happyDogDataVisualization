...
public class happy_dog_bars_circles_tail extends PApplet {
...
public void draw() {
  ...
  strokeWeight(1);
  noFill();
  rect(125.5f, 270.5f, smoothAvgAx-0.5f, 11, 0, 20, 20, 0);
  rect(125.5f, 290.5f, smoothAvgAy-0.5f, 11, 0, 20, 20, 0);
  rect(125.5f, 310.5f, smoothAvgAz-0.5f, 11, 0, 20, 20, 0);
  rect(125.5f, 380.5f, smoothAvgGx-0.5f, 11, 0, 20, 20, 0);
  rect(125.5f, 400.5f, smoothAvgGy-0.5f, 11, 0, 20, 20, 0);
  rect(125.5f, 420.5f, smoothAvgGz-0.5f, 11, 0, 20, 20, 0);
  rect(125.5f, 490.5f, smoothAvgMx-0.5f, 11, 0, 20, 20, 0);
  rect(125.5f, 510.5f, smoothAvgMy-0.5f, 11, 0, 20, 20, 0);
  rect(125.5f, 530.5f, smoothAvgMz-0.5f, 11, 0, 20, 20, 0);
  rect(125.5f, 600.5f, smoothAvgEx-0.5f, 11, 0, 20, 20, 0);
  rect(125.5f, 620.5f, smoothAvgEy-0.5f, 11, 0, 20, 20, 0);
  rect(125.5f, 640.5f, smoothAvgEz-0.5f, 11, 0, 20, 20, 0);
  ...
  noFill();
  for (int i=0;i<23;i++) {
    ellipse(400, 100 + i*25, 22.5f, 22.5f);
  }
  arc(400, 675, 22.5f, 22.5f, PI, TWO_PI);
...
public void keyPressed(){
  ...
  public void settings() {  size(450,800);  smooth(); }
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "happy_dog_bars_circles_tail" };
    if (passedArgs != null) {
